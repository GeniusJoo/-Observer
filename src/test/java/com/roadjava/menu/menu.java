...
{
	CardLayout layout;	//카드레이아웃으로 주기능화면, 부가기능 화면 전환예정 
	menu()
	{
	...
	void setMainmenu() 	//메인기능 화면 구성 메소드
	{
		...
		ImageIcon img1 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/지역.png");
		ImageIcon img2 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/날짜.png");
		ImageIcon img3 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/검색.png");
		//주기능 이미지 버튼 추가
	...
	void setSubmenu() //부가기능 화면 구성 메소드
	{
		...
		//이미지 경로표시 절대좌표 재설정해야함!! 중요
		ImageIcon img1 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/부가기능1.png");
		ImageIcon img2 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/부가기능2.png");
		ImageIcon img3 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/부가기능3.png");
		ImageIcon img4 = new ImageIcon("C:/Users/JungJooYoung/Desktop/고객 그림파일/부가기능4.png");
		//부가기능 이미지 버튼 4개 추가
